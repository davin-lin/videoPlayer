...
///�ı䴰���С���
    ...
    QRect screenRect = QApplication::desktop()->screenGeometry();//��ȡ�豸��Ļ��С
...
void DragAbleWidget::doShowFullScreen()
{
    ...
    this->showFullScreen();
    this->raise();
    ui->widget_frame->setContentsMargins(0,0,0,0); //���ر߿�

    showBorderRadius(false);

    ui->btnMenu_Max->setIcon(QIcon(":/image/shownormalbtn.png"));

    ui->widget_title->hide(); //���ر�����
