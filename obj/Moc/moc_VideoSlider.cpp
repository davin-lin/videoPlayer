...
void VideoSlider::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (VideoSlider::*)(qint64 );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&VideoSlider::sig_clicked)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (VideoSlider::*)(qint64 );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&VideoSlider::sig_setStart)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (VideoSlider::*)(qint64 );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&VideoSlider::sig_setEnd)) {
                *result = 2;
                return;
            }
        }
        {
            using _t = void (VideoSlider::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&VideoSlider::sig_valueChanged)) {
                *result = 3;
                return;
            }
        }
